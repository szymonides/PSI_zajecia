...
# Wczytaj dane tekstowe
text_2 <- "And so even though we face the difficulties of today and tomorrow, I still have a dream. It is a dream deeply rooted in the American dream."
text_2

frequent_terms <- freq_terms(text_2)
frequent_terms
frequent_terms <- freq_terms(text_2, stopwords = Top200Words)
plot(frequent_terms)
